/**
 * Seed script for ConnectaPod Designer modules
 * 
 * Run with: node scripts/seed-modules.js
 * 
 * This script populates the database with all standard ConnectaPod module entries.
 * Modules are organized by category: Living, Bedroom, Bathroom, Laundry, Kitchen, Connection, Soffit, Deck
 */

// Module data following the ConnectaPod naming convention
// Code format: [Category Prefix][Width Code][Chassis Type][Room Type/Variant]
// 
// Width codes: 15 = 1.5m, 18 = 1.8m, 24 = 2.4m, 30 = 3.0m
// Chassis types: C = Center, EF = End Front, ER = End Rear, LF = Left Front, RF = Right Front
// Room types vary by category

const MODULES = [
  // ========== LIVING MODULES ==========
  // Standard open modules with no internal partitions
  {
    category: "Living",
    code: "LV1524C",
  ...
  // ========== BEDROOM MODULES ==========
  // End-of-row modules with finished end walls
  {
    category: "Bedroom",
    code: "BR1524EF",
  ...
  // ========== BATHROOM MODULES ==========
  // Standard bathroom modules with shower, vanity, and toilet
  {
    category: "Bathroom",
    code: "BT1524C",
  ...
  // ========== KITCHEN MODULES ==========
  // End-of-row kitchen modules with full cabinetry
  {
    category: "Kitchen",
    code: "KT1824EF",
  ...
  // ========== CONNECTION MODULES ==========
  // Modules that connect separate pavilions or buildings
  {
    category: "Connection",
    code: "CN1524C",
  ...
  // ========== SOFFIT MODULES ==========
  // Soffit-only modules for covered outdoor areas
  {
    category: "Soffit",
    code: "SF1524EF",
...
// Export for use with the app's API
export { MODULES };

// Print summary for verification
console.log("=== ConnectaPod Module Seed Data ===\n");
...
console.log("\nTo import these modules into the app:");
console.log("1. Go to the Catalogue page");
console.log("2. Use the Bulk Upload feature, or");
console.log("3. Import the MODULES array in your seeding logic\n");

// JSON export for manual import
console.log("JSON format (copy for import):\n");

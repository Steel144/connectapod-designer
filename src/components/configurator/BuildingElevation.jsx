...
export default function BuildingElevation({ walls = [], placedModules = [], stickyTop = 0, navBarHeight = 0, showHeader = true }) {
  ...
  const slotOffset1X = 0.247;
  const slotOffset2X = 0.15;
  const slotOffset3X = 0;
  const slotScale1X = 1.1;
  ...
  return (
    <div className="w-full bg-white flex flex-col">
      ...
      <div
        ...
        ref={containerRef}
      >
        <div ref={contentRef} style={{ padding: "40px", paddingLeft: "1200px", paddingRight: "1000px", display: "inline-flex", flexDirection: "column", gap: 40, minWidth: "max-content" }}>

    ...
    >
      ...
      >
        ...
        <>
          ...
          <div className="absolute pointer-events-none text-black font-bold text-sm" style={{ left: "12px", top: 14 * CELL_H + 4 }}>Pavilion 1</div>
          ...
          <div className="absolute pointer-events-none text-black font-bold text-sm" style={{ left: "12px", top: 24 * CELL_H + 4 }}>Pavilion 2</div>
        </>

        ...
        draggingWall.selectedIds.forEach((wallId) => {
          ...
          if (wall.orientation === "horizontal") {
            ...
            for (const mod of placedModules) {
              ...
              // Only snap if cursor X is over the module's X range
              if (cursorCellX < mod.x || cursorCellX > mod.x + mod.w) continue;
           ...
           for (const mod of placedModules) {
             ...
             // Only snap if cursor Y is over the module's Y range
             if (cursorCellY < mod.y || cursorCellY > mod.y + mod.h) continue;

    ...
    >
      ...
      >
        ...
        <>
          ...
          <div className="absolute pointer-events-none text-green-700 font-bold text-sm" style={{ left: "12px", top: 9 * CELL_H + 4 }}>Pavilion 1</div>
          ...
          <div className="absolute pointer-events-none text-red-700 font-bold text-sm" style={{ left: "12px", top: 19 * CELL_H + 4 }}>Connection Module</div>
          ...
          <div className="absolute pointer-events-none text-blue-700 font-bold text-sm" style={{ left: "12px", top: 26 * CELL_H + 4 }}>Pavilion 2</div>
        </>

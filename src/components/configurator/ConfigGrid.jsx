...
export default function ConfigGrid({ placedModules, onPlace, onRemove, onMove, onRotate, onFlip, walls = [], wallTypes = [], onPlaceWall, onRemoveWall, onFlipWall, onMoveWall, onUpdateWall, onWallSelect, onModuleSelect, onFaceSelect, hidden = false, customModules = [], floorPlanImages = {}, zoom = 100 }) {
         ...
         {placedModules.map((mod) => {
          ...
          return (
            ...
            >
              ...
              {/* Face labels - always visible, directly select face */}
              <>
                <button onClick={() => { onModuleSelect?.(mod); onFaceSelect?.('W'); }} className="absolute top-1 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-white text-gray-900 text-xs font-bold rounded hover:bg-[#F15A22] hover:text-white transition-colors shadow-sm z-20">W</button>

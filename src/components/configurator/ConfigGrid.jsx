        ...
        {placedModules.length > 0 && (() => {
          ...
          return (
            <>
              ...
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: (minX - 1.5) * CELL_W, top: (minY - 1.5) * CELL_H, width: (maxX - minX + 3) * CELL_W, height: 1 }}>
              ...
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: (minX - 1.5) * CELL_W, top: (minY - 1.5) * CELL_H, width: 1, height: (maxY - minY + 3) * CELL_H }}>

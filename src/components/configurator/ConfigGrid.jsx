        ...
        {placedModules.map((mod) => {
          ...
          return (
            ...
            >
              ...
              <span className="absolute text-[9px] font-semibold text-slate-700 text-center leading-tight px-0.5 py-0.5" style={{ bottom: '-36px', left: '50%', transform: 'translateX(-50%) rotate(-90deg)', whiteSpace: 'nowrap', transformOrigin: 'center' }}>
                {mod.label}
              </span>

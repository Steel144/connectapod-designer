        ...
        {placedModules.length > 0 && (() => {
          ...
          return (
            <>
              ...
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: (minX - 1.5) * CELL_W, top: minY * CELL_H, width: 1, height: (maxY - minY) * CELL_H + 6.67 }}>

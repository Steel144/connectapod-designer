        ...
        {placedModules.length > 0 && (() => {
          ...
          return (
            <>
              ...
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: (minX - 1.5) * CELL_W, top: (minY - 0.31) * CELL_H, width: 1, height: (maxY - minY + 0.62) * CELL_H }}>

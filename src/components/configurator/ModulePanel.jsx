                     ...
                     >
                       <div className="shrink-0 w-10 h-16 border border-gray-200 bg-white overflow-hidden relative">
                         {floorPlanImages[mod.type] || floorPlanImages[item.originalCode] ? (
                           <img src={floorPlanImages[mod.type] || floorPlanImages[item.originalCode]} alt={item.name} className="w-full h-full object-cover object-center" style={{clipPath: "inset(0 15%)"}} />
                         ) : (

         ...
         {/* Header with logo */}
           <div className="flex items-center justify-between px-6 pt-4 pb-2 border-b" style={{ borderColor: "#F15A22" }}>
             ...
             <div style={{ textAlign: "center" }}>
               <div style={{ color: "#F15A22", fontSize: "18px", fontWeight: "600" }}>www.connectapod.co.nz</div>
               <div style={{ color: "#888", fontSize: "16px" }}>hello@connectapod.com · 022 396 2657</div>
               <div style={{ color: "#bbb", fontSize: "9px", marginTop: "4px" }}>© {new Date().getFullYear()} Connectapod Ltd. All rights reserved.</div>
             </div>

    ...
    <div className={`flex flex-col items-center ${tight ? "gap-0" : "gap-2"} shrink-0`} style={{ margin: tight ? "-1px 0" : "0" }}>
      <div
        ...
        onMouseEnter={(e) => {
          ...
          console.log("hover rect:", rect);
          setHoverPos({ x: Math.max(0, rect.right + 10), y: Math.max(0, rect.top) });
        }}
        ...
        <div className="flex items-end">
          ...
          <div className="flex items-end">
            {midWalls.map((wall, idx) => (
              <div key={wall.id} className="flex items-end" style={{ marginRight: "-1px" }}>
          ...
          {endRight && (
            <div className="flex items-end shrink-0" style={{ marginLeft: `${Math.round((zoom / 100) * 48)}px` }}>

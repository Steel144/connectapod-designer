...
export default function ElevationGallery({ walls = [], placedModules = [], onWallSelect = () => {}, customWalls = [] }) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", background: "white", display: "flex", flexDirection: "column", minWidth: 0, overflow: "hidden" }}>
      ...
      <div
        style={{ flex: 1, overflow: "auto", background: "#f9fafb", minWidth: 0 }}
        ref={containerRef}
      >

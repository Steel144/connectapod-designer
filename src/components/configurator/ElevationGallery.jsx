...
export default function ElevationGallery({ walls = [], placedModules = [], onWallSelect = () => {}, customWalls = [] }) {
    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center gap-2" style={{ minWidth: "max-content" }}>
          ...
          {endRight && (
            <div className="flex items-center shrink-0" style={{ marginLeft: `${spacingPx}px`, marginTop: `${offsetPx}px` }}>
              <div className="flex flex-col items-center gap-0">
  ...
  return (
    <div style={{ width: "100%", height: "100%", background: "white", display: "flex", flexDirection: "column", minWidth: 0 }}>
      ...
      <div
        style={{ flex: 1, overflowX: "auto", overflowY: "auto", background: "#f9fafb", minWidth: 0, paddingTop: "56px" }}
        ref={containerRef}
      >
        <div ref={contentRef} style={{ display: "inline-block", padding: "40px", paddingLeft: "1200px", paddingRight: "1000px" }}>

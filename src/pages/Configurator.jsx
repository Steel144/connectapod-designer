            ...
            >
              <div className="bg-white border border-gray-200 shadow-xl overflow-hidden" onMouseDown={handleSummaryMouseDown}>
                <div className="px-4 py-3 border-b border-gray-100 cursor-grab active:cursor-grabbing flex items-center justify-between">
                    <p className="text-xs font-semibold text-gray-800 uppercase">{selectedWall ? `Wall: ${selectedWall.face || selectedWall.type || "Preview"}` : hoveredWall ? `Wall: ${hoveredWall.label}` : selectedModule && selectedFace ? `${selectedModule.label} — Face ${selectedFace}` : selectedModule ? `Module: ${selectedModule.label}` : "DESIGN SUMMARY"}</p>

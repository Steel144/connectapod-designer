...
export default function Configurator() {
  ...
  return (
    <div className={`bg-white ${viewMode === "building" ? "fixed inset-0 overflow-auto" : "w-screen h-screen overflow-hidden relative"} flex flex-col`}>
      ...
      {/* ── DESKTOP TOP BAR ── */}
      {!isMobile && (
        <div ref={navBarRef} className={`${viewMode === "building" ? "sticky" : "absolute"} top-0 left-0 right-0 z-30 flex items-center px-4 py-4 bg-white border-b border-gray-200 overflow-x-auto gap-4 min-w-0`}>
      ...
      {/* ── MOBILE TOP BAR ── */}
      {isMobile && (
        <div ref={navBarRef} className={`${viewMode === "building" ? "sticky" : "absolute"} top-0 left-0 right-0 z-30 bg-white border-b border-gray-200 shadow-sm`}>

...
export default function Configurator() {
  ...
  useEffect(() => {
    ...
    const autoSaveInterval = setInterval(() => {
      ...
      base44.entities.HomeDesign.create({
        ...
        // Silently fail — autosave shouldn't disrupt user
      });
    }, 5 * 60 * 1000); // 5 minutes
      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-3">
            <ModulePanel onDragStart={handleDragStart} onDragEnd={handleDragEnd} selectedWall={selectedWall} selectedModule={selectedModule} placedModules={placedModules} onModuleImageUpdate={handleModuleImageUpdate} onWallImageUpdate={handleWallImageUpdate} floorPlanImages={floorPlanImages} />
          </div>
        </div>
